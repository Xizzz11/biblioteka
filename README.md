...
Вводите название, ID автора, год и количество копий.
...
Показывает список книг с авторами, годом и копиями.
...
Выводит информацию о книге по ID.
...
Меняйте название, автора, год или копии.
...
Регистрируйте читателя (имя, фамилия, email).
...
Создает заказ с ID книги и читателя.
...
Фиксирует возврат по ID заказа, увеличивает копии.
...
Вводите ID книги, читателя, рейтинг (1-5) и комментарий.
...
Показывает отзывы для книги по ID.
...
🗄️ Данные хранятся в library.db.



🔄 Для других СУБД (например, SQL Server) измените строку подключения в Program.cs.



🖼️ Диаграммы создавайте в PlantUML для лучшей визуализации.
